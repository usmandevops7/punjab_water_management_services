...
\restrict 9kGJYPyMsWNdhkinjBci2zGcXPbs7we6qqxAZLH2fhci47YTe0tsoO3juUBprto
...
COPY public.district (district_id, district_name, division_id, district_name_ur, boundry) FROM stdin;
\.
...
COPY public.division (id, division_name, division_name_ur, boundry) FROM stdin;
\.
...
COPY public.tehsil (tehsil_id, tehsil_name, district_id, tehsil_name_ur, boundry) FROM stdin;
\.
...
COPY public.union_council (uc_id, uc_name, tehsil_id, us_name_ur, pp, na, boundry) FROM stdin;
\.
...
\unrestrict 9kGJYPyMsWNdhkinjBci2zGcXPbs7we6qqxAZLH2fhci47YTe0tsoO3juUBprto
